...
/* 13: merge adaptive backdrop v12: independent quotient consumers, proven
 *     copied/biased camera inputs, and two biased bounds for terrain strips. */
#define PSX_OVERLAY_CODEGEN_VER 13
