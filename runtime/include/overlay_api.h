...
/* v11: backdrop windows require independent, intact quotient consumers;
 * reject layer offsets previously mistaken for window widths. */
/* v12: camera provenance through copied/biased registers and two independent
 * biased bounds, for multiple terrain strips in one finite column table. */
#define PSX_OVERLAY_CODEGEN_VER 12
