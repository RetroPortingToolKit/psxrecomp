...
def main():
    ...
    capture = (ROOT / "runtime/src/overlay/overlay_capture.c").read_text(encoding="utf-8")
    loader = (ROOT / "runtime/src/overlay/overlay_loader.c").read_text(encoding="utf-8")
    autocompile = (ROOT / "runtime/src/overlay/autocompile.c").read_text(encoding="utf-8")
    memory = (ROOT / "runtime/src/memory/memory.c").read_text(encoding="utf-8")
    gte = (ROOT / "runtime/src/gte/gte.cpp").read_text(encoding="utf-8")
    traps = (ROOT / "runtime/src/cpu/traps.c").read_text(encoding="utf-8")
    interrupts = (ROOT / "runtime/src/cpu/interrupts.c").read_text(encoding="utf-8")
    cycles = (ROOT / "runtime/src/cpu/psx_cycles.c").read_text(encoding="utf-8")
